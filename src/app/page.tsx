          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-20 w-full items-start">
            ...
            <div className="lg:col-span-3">
              <Accordion type="single" collapsible className="w-full flex flex-col gap-4">
                {[
                  { q: "What is SnowPropDeals and how does it benefit traders?", a: "SnowPropDeals is a curated ecosystem providing verified prop firm discounts, exclusive community giveaways, and institutional-grade trading tools." },
            ...
            <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="flex flex-col gap-6">
                ...
                <ul className="flex flex-col gap-5 text-white/40 text-[15px]">
                  ...
                  <li><a href="mailto:info@snowpropdeals.com" className="hover:text-white transition-colors">Contact Us</a></li>
